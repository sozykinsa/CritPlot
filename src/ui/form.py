...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_105 = QVBoxLayout(self.tab_51)
        self.verticalLayout_105.setObjectName(u"verticalLayout_105")
        self.label_124 = QLabel(self.tab_51)
        self.label_124.setObjectName(u"label_124")

        self.verticalLayout_105.addWidget(self.label_124)

        self.FormButtonAddCroData = QPushButton(self.tab_51)
        self.FormButtonAddCroData.setObjectName(u"FormButtonAddCroData")

        self.verticalLayout_105.addWidget(self.FormButtonAddCroData)
        ...
        self.verticalLayout_105.addWidget(self.groupBox_30)

        self.tabWidget_10 = QTabWidget(self.tab_51)
        ...
        self.verticalLayout_27 = QVBoxLayout(self.tab_55)
        self.verticalLayout_27.setObjectName(u"verticalLayout_27")
        self.verticalSpacer_33 = QSpacerItem(20, 527, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.verticalLayout_27.addItem(self.verticalSpacer_33)

        self.tabWidget_10.addTab(self.tab_55, "")

        self.verticalLayout_105.addWidget(self.tabWidget_10)
        ...
        self.verticalLayout_88 = QVBoxLayout(self.tab_39)
        ...
        self.form_critic_from_file = QRadioButton(self.frame_58)
        self.form_critic_from_file.setObjectName(u"form_critic_from_file")

        self.verticalLayout_99.addWidget(self.form_critic_from_file)


        self.verticalLayout_88.addWidget(self.frame_58)
        ...
        self.verticalLayout_88.addWidget(self.widget)
        ...
        self.verticalLayout_9 = QVBoxLayout(self.tab_32)
        ...
        self.verticalLayout_9.addWidget(self.FormSettingsViewCheckShowAtoms)
        ...
        self.verticalLayout_9.addWidget(self.FormSettingsViewCheckShowBox)
        ...
        self.verticalLayout_9.addWidget(self.FormSettingsViewCheckShowAtomNumber)
        ...
        self.verticalLayout_9.addWidget(self.FormSettingsViewCheckShowAxes)
        ...
        self.verticalLayout_9.addWidget(self.groupBox_29)
        ...
        self.verticalLayout_9.addWidget(self.groupBox_34)

        self.show_bcp = QCheckBox(self.tab_32)
        self.show_bcp.setObjectName(u"show_bcp")
        self.show_bcp.setChecked(True)

        self.verticalLayout_9.addWidget(self.show_bcp)

        self.show_bond_path = QCheckBox(self.tab_32)
        self.show_bond_path.setObjectName(u"show_bond_path")
        self.show_bond_path.setChecked(True)

        self.verticalLayout_9.addWidget(self.show_bond_path)

        self.frame_160 = QFrame(self.tab_32)
        ...
        self.horizontalSpacer_82 = QSpacerItem(182, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_122.addItem(self.horizontalSpacer_82)


        self.verticalLayout_9.addWidget(self.frame_119)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"CritPlot", None))
        ...
        self.tabWidget_10.setTabText(self.tabWidget_10.indexOf(self.tab_55), QCoreApplication.translate("MainWindow", u"Show", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_51), QCoreApplication.translate("MainWindow", u"QTAIM", None))
        ...
        self.form_critic_from_file.setText(QCoreApplication.translate("MainWindow", u"All from file", None))
